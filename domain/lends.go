...
type AssetsLend struct {
	...
	LendDate           string     `json:"lend_date"`            // 貸出日 ("YYYY-MM-DD")
	ExpectedReturnDate *string    `json:"expected_return_date"` // 返却予定日 ("YYYY-MM-DD" or null)
	ActualReturnDate   *string    `json:"actual_return_date"`   // 実際の返却日 ("YYYY-MM-DD" or null)
