...
func RegisterRoutes(r *gin.Engine, svc *Service) {
	...
	// masters
	r.POST("/assets/masters", h.CreateAssetMaster)                   //OK
	r.GET("/assets/masters", h.ListAssetMasters)                     //OK
	r.GET("/assets/masters/:management_number", h.GetAssetMaster)    //OK
	r.PUT("/assets/masters/:management_number", h.UpdateAssetMaster) //OK

	// assets
	r.POST("/assets", h.CreateAsset)          //OK
	r.GET("/assets", h.ListAssets)            //OK
	r.GET("/assets/:asset_id", h.GetAsset)    //OK
	r.PUT("/assets/:asset_id", h.UpdateAsset) //OK
}
